...
- **The unit is one story per (person, point) — P1210 §7, founder decision 2026-09-01.** **One sentence, two at most** (P1348, founder 2026-09-22): the experience or reasoning that makes the agent predict this person holds this position. Then that point's quote. The quotes and timecodes carry the evidence and are always visible under the story, so the prose does not restate them. Before P1348 this read *three or four sentences*. This REPLACES *one story per distinct experience, linked to every point it explains* (founder, 2026-08-25), which is what produced run B's 1,496-character digest carrying four unrelated arguments stitched with "the same shift repeats" and compressed until the sentences stopped being English.
