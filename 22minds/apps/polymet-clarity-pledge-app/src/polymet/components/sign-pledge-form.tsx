...
import { createProfile, setCurrentUser } from "@/polymet/data/mock-profiles";
...
export function SignPledgeForm({
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    // Simulate seal animation then API call
    setTimeout(() => {
      // Create the profile in mock data
  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-6">
      ...
      >
        {/* Document Header */}
        <div className="text-center space-y-2 pb-6 border-b-2 border-[#002B5C]">
          <h2
            className="text-3xl md:text-4xl font-serif tracking-wide text-[#1A1A1A]"
            style={{ fontFamily: '"Playfair Display", Georgia, serif' }}
          >
            The Clarity Pledge
          </h2>
          <p className="text-xs text-[#1A1A1A]/60 uppercase tracking-[0.2em] font-sans">
            A Public Promise
          </p>
        </div>
        ...
        <div className="space-y-6 py-6">
          <div className="text-lg leading-relaxed text-[#1A1A1A]">
            <span
          ...
          {/* Divider */}
          <div className="border-t border-[#1A1A1A]/20 my-4" />

          {/* Your Right Section - Matching Certificate Design */}
          <div className="space-y-4">
            <h3 className="text-xl md:text-2xl font-bold text-[#0044CC] tracking-wide">
              YOUR RIGHT
            </h3>
        ...
        <div className="space-y-4 pt-6 border-t-2 border-[#002B5C]">
          ...
          <div className="space-y-2">
            ...
            <textarea
              ...
              rows={3}
              maxLength={280}
              className="w-full px-0 py-2 border-0 border-b-2 border-[#1A1A1A]/40 rounded-none bg-transparent focus-visible:outline-none focus-visible:ring-0 focus-visible:border-[#1A1A1A] resize-none text-sm"
            />
        ...
        <div className="space-y-3">
          <Button
            type="submit"
            className="w-full bg-[#002B5C] hover:bg-[#001f45] text-white font-semibold text-lg py-6 relative overflow-hidden group"
            size="lg"
          ...
          {/* Helper Text */}
          <p className="text-xs text-center text-[#1A1A1A]/60 leading-relaxed">
