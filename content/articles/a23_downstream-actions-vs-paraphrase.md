...
A competing heuristic to ClarityPledge's paraphrase verification: **action articulation** (associated with Karlen) — instead of asking the listener to paraphrase, ask them what they'll *do* with what they heard. The reasoning: actions are concrete; words are slippery.
