...
About nine years ago I was running a sales consulting agency. Part of the job was cold outreach — finding decision-makers, guessing email formats, getting in front of people who weren't expecting to hear from you.
...
So I started applying the principles. I documented mistakes obsessively. I built long lists of what I was learning. And every time I brought on a new co-founder, I'd sit down and go through the list with them.
...
I never wanted any of those separations. Every one was painful. You don't accumulate fourteen co-founder separations because you're cavalier about relationships. You accumulate them because the underlying problem keeps reasserting itself — and you don't yet have the tools to address it before the conflict arrives and it's too late to fix.
...
This is a different kind of cognitive skill than most knowledge work required. It's not about producing output. It's about intention — knowing exactly what you mean, being able to specify processes with precision, and recognizing when the output isn't matching the intent.
...
The second is calibration — the ability to know what you actually understand versus what you think you understand, and to create environments where that gap can be detected and closed in real time.
...
ClarityPledge started as an attempt to spread what I'd learned from Dalio — compressed through my own experience into something operational. A public commitment to a communication protocol: when something important is being communicated, check that you actually understood it before you act on it.

But a pledge changes nothing without an instrument to measure whether it's being kept.

So what I'm building now is the instrument. A calibration tool — specifically, a way to measure conversational comprehension accuracy: how well your self-assessment of your own understanding tracks your actual understanding. A score that changes over time, that creates accountability between team members, that makes the invisible gap between "I think I understood" and "I actually understood" visible and workable.
...
This is what I wish I'd had six years ago. Not a better investor pitch, not a stronger product, not a cleaner Kanban board.

A way to know when I actually understood someone, and when I only thought I did.

Dalio told me to spread it further. I spent nine years compressing what he meant into something I could use. This is where I've landed.
