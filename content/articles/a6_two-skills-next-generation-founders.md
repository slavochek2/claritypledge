...
Not charisma. Not a perfect deck. Not a hot market. [Calibration](https://claritypledge.com/manifesto) — the discipline of actually understanding what someone is telling you, especially when you don't want to hear it.
...
Dalio built [Bridgewater Associates](https://en.wikipedia.org/wiki/Bridgewater_Associates), the largest hedge fund in the world, managing over $200 billion at its peak. He'd recently published [Principles](https://www.principles.com/) — a book distilling the management philosophy behind Bridgewater's success. The core practice: document every significant mistake, and turn each important failure into a principle that prevents you from repeating it. Build radical transparency and radical open-mindedness into every team and every decision.
...
[ClarityPledge](https://claritypledge.com) is an open-source coordination platform for founding teams. If you're building something and you've felt the cost of miscalibration — the co-founder argument that goes nowhere, the feedback you acted on before you actually understood it — I'd like to hear from you.
...
- [The Clarity Tax](https://claritypledge.com/manifesto) — the manifesto behind ClarityPledge
- [Adversarial Interoperability](https://www.eff.org/deeplinks/2019/10/adversarial-interoperability) — Cory Doctorow, EFF
- [Principles](https://www.principles.com/) — Ray Dalio
- [Bridgewater Associates](https://en.wikipedia.org/wiki/Bridgewater_Associates) — Wikipedia
- [The Measurement Gap](https://blog.claritypledge.com/the-measurement-gap/) — why we can't see our own communication blindspots
- [Calibrated Humans for AI Agents](https://blog.claritypledge.com/calibrated-humans-for-ai-agents/) — why human calibration matters more as agents act on our behalf
