...
Bets: [hypotheses.md](hypotheses.md) **H-FounderWince (active P0)** + **H-ProtocolTransfers** (read in the group rung, deferred). Structural positioning: [lean-canvas.md](lean-canvas.md) §UVP (**key-hire page-lead, 2026-07-14** — *"De-risk misalignment with your next key hire."*; the mission slogan + divergent-AI hook + outcome-lead are now `[FALLBACK]` layers below it) + §Customer Segments (Active focus: **seed–A founder with an active key hire**).
