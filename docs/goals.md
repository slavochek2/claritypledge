...
> **[THIS WEEK 2026-09-21 → 2026-09-29, founder direction]** Physical events become **weekly**, automated as far as possible. **Until event #2 (Tue 2026-09-29): physical-event improvement only** — registration with opt-in, prep and survey ([P1336](../features/p1336_registration_carries_opt_in_prep_and_survey.md)), the deck ([P1338](../features/p1338_clarity_night_deck_cut_theory_and_run_rounds.md)), then the event journey ([P1337](../features/p1337_event_journey_on_screen_steps_rotation_and_ending.md)). **From 2026-09-30: champion outreach and online pilots** (the block below), while weekly physical events continue. Founder time on development: about 30%.

> **[ACTIVE 2026-09-21 — founder decision, `UNTESTED`, zero pilots run] Champion-hosted pilots in mid-size organizations (~100–1,000 people).** Supersedes the event-led block below as the **conversion** path; the structural bet is in [lean-canvas.md](lean-canvas.md) §Customer Segments + §Channels, and the reasoning in [decisions.md](decisions.md) 2026-09-21 [product]. **Motion:** find a champion → qualify (the 2026-07-29 throughput trigger + the abandoned-conversation question below) → one free, personally prepared online pilot on a topic the champion supplies → discuss support only if the room shows adoption *(founder-stated)*. *Agent-proposed, unconfirmed:* agree on success criteria before the pilot (e.g. X% opt in, a named disagreement unstuck), but **never** include a follow-up request or an unprompted second adopter, because those are the prediction's outcomes, and a champion told the target has a reason to prompt them · ask early who approves a follow-up · 1–2 low-stakes online rehearsals before the first organization pilot, since the online format is untested. **Public physical events continue as the lab** (run-of-show fixes from event #1 below) and as champion sourcing. They are no longer the conversion channel, and the "one person per company" rule no longer governs the pilot room. **Falsifier:** 5 champion conversations with 0 pilots agreed ⟹ change the pitch; 3 pilots with 0 follow-up requests ⟹ the segment is wrong (thresholds agent-proposed, `[FOUNDER DECISION: overwrite]`). **Still unreconciled below, deliberately:** the event-led block's per-lane rates, the membership ladder and the startup-coordinator multiplier ask (*"can I run this for your startups?"*) were built for the outgoing funnel and are kept as written until the pilot motion produces its own numbers.
>
> **[SUPERSEDED 2026-09-21 as the conversion path → champion-hosted pilots above; events continue as the lab]** **[ACTIVE 2026-08-07 — applied]** **Event-led funnel.** Supersedes the 2026-07-20 direct-first channel. The 2026-08-05 `PROPOSED-PENDING-CONTACT` freeze on this block is **void**: [decisions.md](decisions.md) 2026-08-05 [process] ruled that **no rule may block a write, only require a label**, and named this block's own wording (*"the only permitted action on these two slots is contact"*) as a re-instated withhold — *"a rule that stops him writing does not stop him acting; it only desyncs the docs from what he is already doing."* The same entry supplies the routing: an event's **promotion target is tactical** (this doc), while `active-market-focus` stays structural ([lean-canvas.md](lean-canvas.md)) — **declaring whom an event targets never moves the canvas slot.** **This block is `UNTESTED`: zero events have been run and every rate below is an estimate.**
>
...
>
> **[ACTIVE LADDER 2026-08-10 — membership is the first paid rung. `UNTESTED`, zero events run, zero members *(as of 2026-08-10; event #1 ran 2026-09-18)*.]** **free repeating events** (the not-yet-convinced come back; replaces the replay lane) → **Clarity Practice Community, €295/month** (**3–10 people**, weekly, ~10h/month founder time, **monthly and open-ended with a month-3 milestone: they are running it in their own Clarity Organization**) → **install €4,500** (accelerator, for those who do *not* want to do the work themselves) → 1:1 coaching. **Guests:** members bring colleagues free, or paid as one-time spectators. **The in-room opt-in is the Clarity Organization terms, not the CPA.** **Why the order changed:** the free event attracts a champion with **no budget and no authority**, and €4,500 is unreachable to that person while €295/month is payable personally — *buyer ≠ sufferer* applied to our own funnel. **Consequences:** event #1 needs **~6–8 attendees, not 20** (the 20-seat figure serves the throughput arithmetic below, whose rates come from nowhere; event #1's job is one sale). The **€1,000 phase-1-at-the-event close is off** — the event's spoken CTA is the membership. **Event topic:** argue the protocol's **premise**, not its mechanics (*"Most disagreements in your team are about words, not about the world"*) — once without the protocol, then again with it, with the CPA + `>7` gate offered **between** rounds so the room feels the failure before it is offered the fix. `[FOUNDER DECISION: exact wording]`. **[AMENDED 2026-08-16 — the line above is retained, not deleted; neither has been run.]** The event **enters** on *"Do you have an agreed feedback process — where each of you knows that the other knows it?"* and **never argues our own method** (that re-commits the rejected "argue the mechanics" alternative and selects for consultants). One shape, **two configurations, differing only by topic-source**: **online (funnel) — the founder picks the topic**, prepared and repeated, starting with feedback material so entry question, argument and offer share one subject; **offline (Chiang Mai) — the room brings the topic**, which is what makes it a forum and is the content/community driver feeding the online one. **[SEEDING EXCEPTION 2026-08-27 — event #1 only, founder decision.]** Event #1 runs **founder-picked**: the Chiang Mai instance has one member, so no room exists yet to propose or vote. Open-forum origin is the **target state, not an entry condition** — the convergence mechanism is the closing paper shortlist at every event, so event #2's topic comes from event #1's room. The open forum (propose and vote on the night) is **v2**. This does **not** move the online/offline split or the naming resolution below: the two configurations still differ only by topic-source, and offline's source is still *the room* — from event #2 onward. Description: [docs/events/clarity-practice-event.md](events/clarity-practice-event.md) § Event #1 — the seeding exception. Description + run-of-show: [docs/events/clarity-practice-event.md](events/clarity-practice-event.md). Rationale: [decisions.md](decisions.md) 2026-08-16 [product]. **Falsifier:** in-room opt-ins decline the €295 membership at the same rate as non-opt-ins across the first ~3 events ⟹ the opt-in is not a qualifier. Rationale: [decisions.md](decisions.md) 2026-08-10 [product] · [lean-canvas.md](lean-canvas.md) §Revenue → Active focus.
>
> **[NAMING + TIER RESOLUTION 2026-08-19 — founder decision. `UNTESTED`, zero events run, zero members, zero paid members *(as of 2026-08-19; event #1 ran 2026-09-18)*. Subordinate to the ladder above; it renames and re-homes the paid rung, it does not move a rung.]** The rung above is named **"Clarity Practice Community, €295/month"** while the organization seeded 2026-07-24 is **"Clarity Practice Community · Chiang Mai"** — one name, one free thing and one paid thing, and the sentence *"join the Clarity Practice Community"* spoken from stage therefore means both. **Resolved in three layers:** **Clarity Organization** is the *kind* (the container, what the terms are called, what the schema calls it — unchanged, never marketed); **Clarity Practice Community · Chiang Mai** and **Clarity Practice Community · Online** are the *instances* (two, matching the topic-source split already recorded above — the founder picks the topic online, the room brings it offline); and the paid rung is a **level inside an instance**, `[FOUNDER DECISION: name]`, **no longer a separately-named product**. **What the paid level buys:** events only paid members may join, **visible on the org page to everyone** — so a free member sees the offer sitting there locked, and the upgrade path needs nobody to pitch it. **Why this and not a third community:** a third container would need its own page, roster and terms to express what is really one property of a person; and free-then-paid inside one room is what the ladder already assumes when it says *"the in-room opt-in is the Clarity Organization terms, not the CPA."* **Consequence to hold, not solve:** the rung's *3–10 people, weekly* cohort property now comes from the size of the paid roster rather than from a wall — it holds at 3–10 paid members and stops holding at 30 (cap or split then). **Gap with no owner:** the rung's month-3 milestone is *"they are running it in their own Clarity Organization"*, but **no create-organization capability exists for anyone** — [p1010](../features/done/2026-06-10/p1010_clarity_organizations_community_container.md) made `/org/:slug` a lookup and never a creation surface, so the milestone currently requires the founder to hand-seed an org per member. Fine for member one; needs its own spec before member three. **Falsifier:** if free members of an instance, having seen the locked paid events on the page for ~3 months, convert at no better rate than event attendees who never joined an organization ⇒ in-page visibility is not an upgrade path and the paid level should be sold from stage instead. Implementation: [p1060](../features/p1060_link_events_to_organizations.md) (widened 2026-08-19 — events belong to an org, the · Online instance, membership levels, gated events). **Not yet applied to [lean-canvas.md](lean-canvas.md) §Revenue**, which still names the rung "Clarity Practice Community" — that edit runs through `/slava:maintain:docs-strategy-update`.
>
> **[CANDIDATE RUNG 2026-08-13 — "run it in my house". `UNTESTED`, zero events run *(as of 2026-08-13; event #1 ran 2026-09-18)*, price a `[FOUNDER DECISION]` placeholder.]** A rung the ladder above does not contain: **the founder runs the same event, unchanged, inside the attendee's own organization** — same fishbowl, same CMP opt-in, same point set ([p1055](../features/p1055_norm_measurement_instrument.md)). Founder's opening figure: **~€300**, the same order as the membership. **Why it may be the easier sell than either neighbour:** the champion who attends has no budget and no authority for €4,500, and the membership asks them to carry the practice home alone — this asks them to carry nothing. They bring the room instead, and the people they need to convince experience it directly rather than hearing it second-hand. It also converts the champion's hardest job (explaining it) into an invitation. **Open, and the reason this is a candidate and not a rung:** whether one event inside a company produces anything durable without a follow-on, and whether ~€300 is coherent beside a €295/month membership that buys recurring access — a one-off at the same price may cannibalise the recurring rung rather than feed it. **Falsifier:** attendees who buy an in-house event convert to membership or install at no better rate than those who don't ⟹ it is a paid demo with no ladder position, and should be priced as lead-gen or dropped.
>
> **[SUPERSEDED 2026-08-10 → the ladder above; the install survives one rung later, the phase-1-at-event close does not] Ladder — the paid event is killed (2026-08-07).** free event → **team install (€4,500, banded)**, with the install's **phase 1 sold at the event**. **Paid intro hour (€250)** stays *off-path*, for the unqualified — selling hours to a *qualified* buyer competes with the install and re-anchors on hours, the defect this ladder exists to correct. The "bring one person" paid-event rung is **removed**: it was the riskiest assumption in the ladder, paid rungs here are **0-for-4**, and [decisions.md](decisions.md) 2026-08-05 already modelled the no-paid-rung case and named the consequence — *"the install price must carry the funnel."* At €2,000 the paid event was load-bearing; **at €4,500 it is not** (€13,500 / 151h = **€89/hr**, beating every row of the retired scenario table without adding a single event).
>
...
>
> **[QUALIFIER — conversation-sourced 2026-09-14, `UNTESTED`, never asked. ADDS a question; touches neither instrument above.]** *"What conversation in your organization has everyone quietly given up on having?"* `[FOUNDER DECISION: exact wording]`. **Why it is different:** the declaration above asks for a *live* disagreement; this finds the *abandoned* one — stopped because both sides predict it will go nowhere. People do not list those as disagreements, so the declaration misses them. It filters for a stuck decision (budget), not for enthusiasm. **Use:** a champion/prospect qualifier, not an opener. **Falsifier:** across the first ~5 champion conversations, people who name an abandoned conversation agree to a pilot at no higher rate than those who cannot. Source: founder `[/cp]` marker, 2026-09-14 conversation.
>
...
> **[SUPERSEDED 2026-08-05 → event-led funnel above]** **Wedge flip (2026-07-20 — see [decisions.md](decisions.md) 2026-07-20 [product]).** Active wedge moved from **key-hire (founder↔new hire)** to **H-BuildRightThing**: a *growing seed–A team* keeps building the wrong things because they never verify they understood each other before agreeing/disagreeing. Enters through **felt** pain (no reveal needed), findable by the growth signal. **Target:** growing seed–A team (2+ people), not a founder-with-a-key-hire. ~~**Offer:** contingent POC — pay only if within a month it surfaces a gap they pre-nominated as high-stakes (**floor €1500**)~~ — **retired 2026-08-05**, applying the 2026-07-24 fixed-price-install supersession whose hand-off was never run; the pay-gate conflated *does the construct exist* with *will they pay* and put delivery risk on the founder. ~~**Channel:** direct-first~~ — superseded by the event above. **Delivery caveat (still live):** `/align` is redefined as **transcript → letter**; it belongs at the **install** (the paid-event rung it also named was killed 2026-08-07), **not** as a free-event CTA — handing a stranger a tool to use with an absent third party recreates the condition behind the letter's R₀≈0 result. Key-hire content below is **dormant-revivable**. The rung ladder + funnel math below still describe the superseded key-hire/coaching motion. **[The completions figure here is FALSE — prod 2026-08-14: 28 deliveries / 12 completed (43%). The 2026-06-02 transform still fired legitimately on the OR's *zero forwards* leg; both legs are false now ⇒ grounds to revisit. See [hypotheses.md](hypotheses.md#corrected-the-completions-figure) H-LetterAsProduct §CORRECTED + decisions.md 2026-08-27.]**

Bets: [hypotheses.md](hypotheses.md) **H-BuildRightThing (P0 bet — splitting into -Sell / -Cause, 2026-08-05; its wedge is dormant since 2026-09-21, see [lean-canvas.md](lean-canvas.md) §Customer Segments)** + **H-WorkshopFormat** (the event bet; `Active P1` since 2026-04-02 with **zero workshops run**, so its `<10% conversion after 3 workshops` transform-if has never been reachable) + **H-ProtocolTransfers / H-FunnelRepeatability** (wedge-general sub-bets, carried forward). **[Dormant] H-FounderWince** (key-hire, revivable). Structural positioning: [lean-canvas.md](lean-canvas.md) §UVP + §Customer Segments.

**Core outcome (re-sequenced 2026-09-04) — [RE-SEQUENCED AGAIN 2026-09-21 by the champion-pilot block at the top of this doc: event #1 is done, and the install below is now sourced through a champion pilot, not the public event; kept as written until the pilot motion has its own numbers]:** run **event #1 first**, then the **multiplier campaign** (~15 coordinator conversations → rooms) — the multiplier ask *"can I run this for your startups?"* presupposes a run that exists, so it is empty until one does ([decisions.md](decisions.md) 2026-09-04 [product]). **Event #1 ran 2026-09-18** (Clarity Night #1, AI safety, Chiang Mai — a public audience, **not** the target segment). Result: **12 room members, one of them the host's own account: all 11 attendees opted into the meeting principle, 0 opted out** (verified 2026-09-21 from prod `event_room_members`, read-only; the recollection was ~13). Without the host (re-counted the same day): 8 of 11 rated their understanding 8+ of 10, 11 of 11 staked at least one cmp7 point, and 9 staked all 7. How many revised a position is not established: the history table records first stakes too. Recording: 3 transcribe rooms captured raw messages (66, 0, 572), but every merged transcript came out with **0 segments**, cause unknown. 3 joined the Clarity group and 3 more wanted to but live elsewhere. **Frictions (attendee feedback):** too much theory before practice · late arrivals forced repeats · pairs stuck together · nobody assigned speaker/listener roles unprompted · confusing click-flow · AI safety a weaker topic fit than issues everyone holds a view on. **Next-event changes:** opt-in + a 10-min prep + a disagreement survey move to registration (non-completers observe) · on-time reminder · theory cut to ~5 min · timed forced rotation · one on-screen step flow · S/L lanyard cards (ordered) · test a topic choice (ikigai / polarizing / pick-from-3) · manual matching from the survey. **Deferred until data exists:** live mirror agents, story fitness scoring, a digital badge. Source: 2026-09-21 debrief conversation, surfaced by that day's `/claude-conversations-to-cp` run. Then land the **first fixed-price install** for **H-BuildRightThing-Sell** — sourced through the free event, closed on a free 30-min scoping call, **€4,500 with €1,000 phase 1 taken at the event** (see the ladder above; the *target* segment is still `PROPOSED`, not settled). Revenue is a **bridge with a tripwire** (runway + the reps that *package* the product), not the mission ([decisions.md](decisions.md) 2026-07-11 [product]).
...
2. **Pre-screen = the 15-min intro call** (`/intro`, booked from the cp `/` CTA) — Gates 1–4 (`discovery-questions.md` Phase 1) run as conversation, not an async form. Filters ICP-5 + state layer before the 90-min audit is committed. **An async form gate before the call was rejected** ([P989](../features/archive/2026-07/p989_pre_audit_qualification_gate.md), 2026-07-15): the call already screens, a self-report form mis-filters the exact founder the wedge targets, and a fit lost to form friction costs far more than the 15 min a non-fit costs. Self-select signage lives in the calendar description. **Revisit when the calls become the constraint (~10+/week).**
...
**Before outreach (minimum):** a ladischenski.com page/blurb + booking link for the free session (divergent-AI hook, no public price). **cp front door is now in scope (supersedes the earlier "cp untouched", 2026-07-13 — [decisions.md](decisions.md)):** the stale co-founder surfaces (`/` ProgramPage + `/program` €950 offer) contradict the active key-hire wedge and are realigned in P987; removing a mission-contradicting asset is cleanup, not new-funnel build. **The audit funnel front-end (priming calc + pre-qualification gate + booking) is on cp** (P987/P989/P992, [decisions.md](decisions.md) 2026-07-15) — one domain, no cross-domain hop; **ladischenski.com holds the coaching-*service* page** (founder-delivered 1:1 delivery, not top-of-funnel). The cp group rung stays deferred. Track the ladischenski build as a task in the `ladischenski-com` repo (no cp-kanban ticket — different repo).

---

## Dormant / Superseded (git history holds the detail)
...
- [hypotheses.md](hypotheses.md) — **H-BuildRightThing (P0 bet; wedge dormant 2026-09-21)**, H-ProtocolTransfers, H-FunnelRepeatability; **H-FounderWince (dormant 2026-07-20, revivable)**
