...
| H-SolopreneurWince | A solopreneur feels a real wince (betting on a belief no one stress-tested; won't reveal own gaps when values clash) and pulls toward a room that fixes it | Active | P0 | — | New 2026-07-01 — market-focus shift to solopreneurs (reachable single-person funnel). Root = **will**-to-reveal, not skill. Test = ~5 live 1:1 diagnostics. **UNTESTED.** |
| H-TherapistRetention | Therapists license the protocol because a pre-committed CPA keeps clients who would otherwise drop out at the challenge/rupture moment | Parked | — | — | Demoted 2026-07-01 on the merits (normal error-correction, not a mistake) — epistemic-trust-floor mismatch, cash-poor/waitlisted buyer, safety overhead, no warm reach. Superseded-as-active by H-SolopreneurWince; kept-not-deleted, revivable. **UNTESTED.** |
