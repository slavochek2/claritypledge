...
- **State-layer refinement (2026-07-10, UNTESTED — 5th interview, Johan/YakYak):** the ICP-5 is a **structural filter, necessary not sufficient.** Buying needs a **STATE layer** the criteria miss: **(a) a live dyad** (a specific person *right now* whose understanding is being bet on — Johan's planned hire was a dream, not a dyad, so the reveal had nothing to bite on); **(b) slack** (room to act, not survival); **(c) felt stakes** (being wrong hurts them soon, personally). Two disqualifier modes both seen: **too-early** (Johan — no dyad, cost-absorbed / low felt stakes) and **too-late** (his ex-CEO — 2M raised, survival crowds out culture-spend). Window ≈ **seed–A**; sharpest trigger = an **active key hire** ("de-risk this hire / cut churn on your critical hires"). **Attribution mismatch** (feels the loss but credits bond / similarity / 1-on-1s, not understanding) is the reveal's **target**, not a disqualifier — *provided a live dyad exists* (the reveal breaks the mismatch). **Reachability → champion:** post-raise founders are hard to reach cold → the **referrer/champion is the acquisition mechanism** for this segment, not a side lane (aligns H-FunnelRepeatability + H-ChampionYield); opens the **CAC/price fork** (cheap price XOR cold-expensive acquisition), resolved *after* the reveal-fires test, not before. n=2 with Martin on the wrong-owner / state-mismatch pattern (corroborating, **not** wedge-moving). **Falsifier:** if founders who *fail* the state layer pull just as hard as those who pass, the layer doesn't filter — revert to ICP-5-only; and if seed–A converts no better than pre-seed / late-stage, the window framing is wrong. See [decisions.md](decisions.md) 2026-07-10 [product] · `.private/docs/business/founders/johan-yakyak-analysis-2026-07-10.md`.
