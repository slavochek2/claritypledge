...
| H-TherapistRetention | Therapists license the protocol because a pre-committed CPA keeps clients who would otherwise drop out at the challenge/rupture moment | Active | P0 | — | New 2026-06-29 — market-focus shift. Problem textbook (rupture-repair / epistemic trust); wedge = agreement-decoupled + will-primary + client-side + transferable. **UNTESTED.** |
