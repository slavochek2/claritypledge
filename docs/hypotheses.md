...
- **ICP-bifurcation (watch-item, n=1):** *product-direction owner* (customer understanding = the wedge) vs *team lead* (internal shared meaning); Martin volunteered the team-internal pain. **Do not move the wedge on n=1** — re-cut only on a 2nd/3rd corroboration.
