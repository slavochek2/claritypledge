...
> **Membership is the first paid rung (2026-08-10). `UNTESTED` — zero events run, zero members. Reverses P1027 (2026-08-07), which set the install at rung 1.** Free event → **Clarity Practice Community, €295/month** (7–10 people, weekly, ~10h/month founder time) → **install €4,500** (accelerator, for those who do *not* want to do the work themselves) → 1:1 coaching. All prices `[FOUNDER DECISION]`.
>
