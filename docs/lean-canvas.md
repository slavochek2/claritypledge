...
**Positioning in flux — frozen until tested (2026-06-04).** Supersedes the "selection vs coordination, audience-selected alternates" framing above (and the matching note in §Customer Segments). Corrected cut: the hook is always **pain, and pain is audience-specific** — founder-facing = the split ("verify before you commit"); coach-facing = the coach's own retention/feedback pain. **"Coordination tooling" is the category revealed in the demo, NOT a sellable headline** — categories don't sell, pains do. **Contested:** the coach-retention-adoption hook is NOT validated — field observation shows coaches resisting it ("we have our own methods"); the co-delivery entry (co-host an event rather than ask a coach to adopt a tool) is the untested response. **Do not re-cut this section in conversation again — the next rewrite is earned by the first real co-delivery, not another discussion.** See [decisions.md](decisions.md) 2026-06-02 [product].

**Value map — gains × pains (2026-06-09, founder articulation).** A value *inventory* beneath the frozen hook above — **not** a positioning re-cut; the wedge pain matches the frozen founder-facing cut ("the split"). Avoided-cost figures are illustrative, not measured. Sort the 8 gains by the affective → cognitive → validity layers; pitch **one** wedge pain, not all seven.
