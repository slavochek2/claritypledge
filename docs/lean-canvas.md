...
- **Problem:** not "False Agreement between cofounders → conflict" but *client can neither **trigger** nor **receive** verification at the disagreement moment → therapist's paraphrase-bid **bounces** → dropout* (low epistemic trust / receptivity). Therapist is skilled; the gap is client-side (see Therapist value-model → Problem).
...
- **Revenue:** not the €950/FCO/workshop ladder but **certification** (NVC-model, scalable online course) — see Therapist value-model → Revenue form. `[FOUNDER DECISION: pricing]`.
...
- **Market Size:** not ICF coaches / cofounder-breakup % but **# of therapists × client-churn-over-surfaced-disagreement**. *Estimate (UNVERIFIED, pending Test (c) interview + desk research):* ~30-80k reachable relational/couples/EFT-Gottman/mentalization therapists globally; at ~€500 cert + small recurring, 1-2% of 50k ≈ €250-500k — impact-business scale, consistent with "revenue is proof of impact, therefore second."
