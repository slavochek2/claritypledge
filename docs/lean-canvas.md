...
- **Current Alternatives:** not Miro/Slido/Gong/360 but **PREP, EFT, the therapist's own methods, doing nothing** — and, for the repair *protocol* itself, **NVC** (closest free substitute; differentiation in value-model above).
...
For the pre-PMF founder / customer-development-clarity domain, the competitive set is **not** Miro/Slido/Gong/360 but: **YC Startup School / "talk to users"**, **The Mom Test** (Rob Fitzpatrick), **Teresa Torres continuous-discovery**, **founder masterminds**, **cohort courses** (On Deck-style), **indie-hacker communities**, **accelerators**, and **AI-cofounder tools**. And, as always, **doing nothing / your AI that only agrees**. CP differentiator (bet): it attacks the *self-fooling* failure mode — you believe you understood the customer and were wrong — with **verified understanding practiced in a stage-matched peer room**, where the others teach methodology/network but not comprehension fidelity. Falsifier: [decisions.md](decisions.md) 2026-07-04 [product].
