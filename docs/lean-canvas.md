...
**Illusion of common belief — addition to Pinker (2026-03-28):** Pinker identifies two epistemic states: shared knowledge and common knowledge. ClarityPledge's core theoretical contribution is a third state: the *illusion of common belief* — both parties believe they have common belief but don't. (We use *belief* rather than *knowledge*: in the strict game-theoretic sense, common knowledge requires the content to be true, and our construct applies to contested and potentially false content as well.) This is the default state of natural language comprehension. Pinker's examples of failed common knowledge are about *absence* (information never made public). Ours are about *illusion* (information exchanged, comprehension believed, but wrong). The instrument detects the illusion and transitions it to verified common belief. Four states of belief: private → illusory common → shared → common. Literature: hindsight bias erases the evidence of change (Fischhoff), illusion of explanatory depth exposed by explanation attempts (Rozenblit & Keil 2002), extreme illusion of understanding — both wrongly believe communication succeeded and neither seeks correction (Lau et al. 2022).

**Three-layer epistemic model (2026-04-25) — refinement under "illusion of common belief".** The named construct stays. The mechanism resolves into three layers underneath: (1) **Intent** — the speaker's act of trying to convey M. The speaker has privileged access to the *intent to convey*, not to M itself. This asymmetry is the epistemic anchor that gives the speaker authority to confirm whether the listener's reconstruction matches. (2) **Meaning** — M itself; the content the intent is to convey. This is the layer where the listener-speaker comparison happens. (3) **Belief** — the meta-attitude about whether comprehension was achieved. This is where the *illusion* lives and where the protocol dissolves it. The bias is at the belief layer; the lever is at the intent layer; the comparison happens at the meaning layer. **Referent-absence corollary:** Most propositional beliefs ("it's raining") have an external referent — the illusion there is puncturable by appeal to a shared object. Beliefs about meaning have no external referent — the only ground truth is the other mind. So semantic common-belief illusions are the case where Pinker's recursive structure cannot be cashed out by observation, only by verification protocol. This is what makes the Clarity Flip uniquely suited to the semantic case.

**Curse of knowledge vs. illusion of common belief (2026-04-08):** Preemptive distinction for the #1 objection ("isn't this just the curse of knowledge?"). Curse of knowledge (Camerer, Loewenstein, Weber 1989) = individual cognitive bias — I can't simulate your ignorance. Illusion of common belief (ClarityPledge term) = group-level epistemic failure — I believe we mutually believe X, but that recursive structure hasn't been verified. The curse is one *cause* of the illusion, but so are politeness norms, time pressure, assumed context, and power dynamics. Critical difference: the curse is deep in cognition (hard to fix); the illusion is puncturable by verification (that's the product).
