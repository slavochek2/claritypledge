...
- **Constraints:**
  - One story per (person, point) — P1210 §7, founder 2026-09-01. This REPLACES *one story per distinct experience*: one sentence, two at most (P1348), on why that person holds that position, then that point's quote.
