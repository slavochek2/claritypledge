...
|---|---|---|---|
| H-LetterAsProduct | A public clarity letter spreads the practice async/virally | <3 completions after 30 days OR zero forwards | **Killed 2026-06-02 — legitimately** (the criterion is an OR; the *zero forwards* leg was true that day). **The completions figure was wrong when written:** prod 2026-08-14 shows 28 deliveries / 12 completed (43%), 4 predating the measurement. Both legs are false now (12 completions, 1 forward) ⇒ **grounds to revisit**, not grounds to call the kill a mistake. [hypotheses.md](hypotheses.md#corrected-the-completions-figure) §CORRECTED |
