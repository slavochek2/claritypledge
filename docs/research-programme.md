...
**Origin:** [P1026](../features/p1026_research_programme_rigor_layer.md), founder decisions D1–D4 resolved 2026-08-07. That spec holds the rejected alternatives and the reasoning for each decision below.
...
| Paraphrase-gated persuasion as a mechanic | **Cite prior art, never claim discovery** — Gottman-Rapoport for the clinical/couples domain; closed-loop readback / the two-challenge rule (crew resource management) for the work domain. |
