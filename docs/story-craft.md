...
>
> **Length now binds by sentence count, owned by `story-draft.md` §Story structure (P1348).** With a
> one-sentence story, §2 below applies to that sentence: it must start the reasoning, not announce it.
