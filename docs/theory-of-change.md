...
> **Near-term market-focus shift (2026-07-01, hypothesis — UNTESTED):** active near-term focus is **founders / solo AI builders** (H-FounderWince, [hypotheses.md](hypotheses.md); [decisions.md](decisions.md) 2026-07-01 [product]) — single-person funnel, reachable, growing. The prior therapist-client-retention focus is **demoted to a parked segment with reasons** (see [lean-canvas.md](lean-canvas.md) §Customer Segments — epistemic-trust-floor mismatch, cash-poor buyer, safety overhead, no warm reach). This long-term cascade (cofounder-seeded, √N) is the **end-state, left intact** — not reversed; the near-term GTM is the founder wince-test.
