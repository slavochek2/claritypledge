...
> **Which market is active is NOT stated here.** See *"Current priority — NOT stated here (corrected 2026-08-06)"* further down this doc, which makes [lean-canvas.md](lean-canvas.md) §Customer Segments (`SINGLE-VALUE: active-market-focus`) the owner. **This callout was violating that rule from the top of the same file:** until 2026-08-10 it named *"founders / solo AI builders"* (H-FounderWince) as the active near-term focus — a framing the 2026-07-20 wedge flip retired — so the doc contradicted itself and the 2026-08-06 correction reached only one of the two places that needed it. Fixed the same way and for the same reason: *a restated fact rots, a pointer cannot* ([decisions.md](decisions.md) 2026-08-05 · 2026-08-10 [process]). **What this doc does own is unchanged:** the long-term cascade (cofounder-seeded, √N) is the **end-state, left intact — not reversed** by any market shift, and applies to whichever segment is active. Near-term GTM belongs to [goals.md](goals.md); the therapist-client-retention focus stays **parked with reasons** (see [lean-canvas.md](lean-canvas.md) §Customer Segments — epistemic-trust-floor mismatch, cash-poor buyer, safety overhead, no warm reach).
...
**Epistemic mechanism (2026-04-13):** The Clarity Letter operationalizes Popper's missing prerequisite — verified comprehension of counterarguments — without requiring the reader to adopt critical rationalism. The letter embeds the practice so that readers who complete it are doing falsification correctly (testing their beliefs against verified counterarguments, not their own reconstructions) without needing the label. This is why the letter works for audiences who've never heard of Popper and for rationalists who already agree with him but lack the mechanism. The emotional charge comes from a relational gap (she didn't know that he knew what she knew), not an abstract one. A machine can demonstrate that paraphrasing is hard, but can't reveal the specific gap between two real people. Implication: the Clarity Letter is architecturally correct — it does what async CAN do (surface disagreements, pre-load positions, file guesses) while leaving the live session for what only live can do (collapse recursive uncertainty with a real counterparty who insists "no, that's not what I meant"). Any feature proposal that tries to deliver the flip without a counterparty is a dead-end investment.
...
**Near-term distribution (2026-06-02): coaches are the primary channel.** Sold THROUGH coaches (coach-of-coaches first); accelerators secondary; founders are the proof/end-user, not the acquisition surface. R₀≈0 (canonical evidence: [hypotheses.md](hypotheses.md) H-LetterAsProduct) retired the viral letter front door. The cascade below remains the long-term end-state; the channel that *carries* it near-term is the coach. The √N end-state and Seven-Stage Cascade are unchanged. Falsifier: [decisions.md](decisions.md) 2026-06-02 [product]. **[The completions figure here is FALSE — prod 2026-08-14: 28 deliveries / 12 completed (43%). The 2026-06-02 transform still fired legitimately on the OR's *zero forwards* leg; both legs are false now ⇒ grounds to revisit. See [hypotheses.md](hypotheses.md#corrected-the-completions-figure) H-LetterAsProduct §CORRECTED + decisions.md 2026-08-27.]**
...
- Right to verified reception (emerging frame, 2026-04-06): Freedom of expression (UDHR Art. 19) covers output — the right to speak. No legal or philosophical framework formalizes the right to verify that you were *understood*. The protocol operationalizes a contextual right that activates wherever consequences are asymmetric: binding agreements, employment, contracts, partnerships. Precedents already exist in narrow domains — courts verify defendants understand their rights, informed consent requires patients to demonstrate comprehension — but only when someone might die or go to prison. People get destroyed by unverified understanding in partnerships and contracts every day; the threshold is set too high. The right is: you can request a prediction score and a paraphrase. The duty is: refusal cannot be invisible. Not as radical as it sounds — extending existing norms with a measurement tool. "Seatbelts, not revolution."
...
**Consequence:** the end-state lines above ("coordination unlocked") hold for the **comprehension layer** only. Trust that a commitment will be kept is a separate layer that this mechanism does not supply. That is consistent with [hypotheses.md](hypotheses.md) H-GroupCounterparty, which makes internal verification a *precondition* for a group's commitment to bind. A precondition is necessary; this limit adds that it is not sufficient. A result where everyone passes the comprehension check and still disagrees is the protocol working (understood-and-rejected), not failing.
...
The **explain-back protocol** spreads through workshops and Partner Agreements. **Near-term distribution update (2026-06-02): the protocol is now sold THROUGH coaches (primary; coach-of-coaches first), with founders as the proof/end-user, not the acquisition surface — R₀≈0 **[The completions figure here is FALSE — prod 2026-08-14: 28 deliveries / 12 completed (43%). The 2026-06-02 transform still fired legitimately on the OR's *zero forwards* leg; both legs are false now ⇒ grounds to revisit. See [hypotheses.md](hypotheses.md#corrected-the-completions-figure) H-LetterAsProduct §CORRECTED + decisions.md 2026-08-27.]** retired the earlier viral/no-coach front door (see [decisions.md](decisions.md) 2026-06-02 [product]).** *([SUPERSEDED 2026-07-03 → dormant Posture 1]: the active near-term channel is now founder-direct — [goals.md](goals.md) §Active, [decisions.md](decisions.md) 2026-07-03 [product]; the coach framing here is the dormant fallback.)* The near-term mechanism:
...
**Coach-mediated distribution (promoted to PRIMARY near-term, 2026-06-02):** Coach-mediated distribution is now the primary near-term mechanism — sold THROUGH coaches (coach-of-coaches first); founders are proof, not the acquisition surface. (Supersedes the 2026-03 "deprioritized" framing after R₀≈0 retired the viral front door.) See [decisions.md](decisions.md) 2026-06-02 [product]. **[The completions figure here is FALSE — prod 2026-08-14: 28 deliveries / 12 completed (43%). The 2026-06-02 transform still fired legitimately on the OR's *zero forwards* leg; both legs are false now ⇒ grounds to revisit. See [hypotheses.md](hypotheses.md#corrected-the-completions-figure) H-LetterAsProduct §CORRECTED + decisions.md 2026-08-27.]**
...
**Framing dependency — added 2026-08-12, `UNTESTED`. Sits alongside the data-dependency note below, and is the more binding of the two.** This path has always assumed the *data* was the constraint. The framing is a second constraint, and it was stress-tested in conversation this window:

- **The claim that gets posted is NOT *"alignment between humans is a prerequisite for alignment between humans and AI."*** It fails falsifiability, and the strongest objection uses the project's own tools: **racing labs understand each other fine** — their binding constraint is conflicting incentives under competitive pressure, not unverified mutual comprehension. Keep it as a tagline if desired; it cannot carry a post to this audience. Two narrower claims survive and are what should be posted: **"cheaper discovery of irreducible disagreement"** (verification does not dissolve interest conflicts, it makes them legible faster) and **"we test whether human review of AI output is real or theatre"** (almost every oversight scheme ends with a human checking, and that check only works if the person understood what they checked).
- **A second problem, in our own story:** one telling has AI *accelerating divergence* → polarization; another has authoritarianism *relying on homogeneity* → everyone querying one model. Those are opposite states, and a theory explaining both explains nothing. A coherent version exists — homogeneity inside blocs, divergence across them, with verification skill being what crosses a bloc boundary — but it must be committed to in writing with a prediction that rules something out.
- **The post's first job is falsification, not recognition.** This community returns a verdict in roughly 48 hours, for free, and it is the cheapest external judge the project has access to. Treating the post as a credibility play rather than a test is what has kept it from being written.
- **Immune-response risk, and it aims at this exact audience.** Pledgers open organizations, recruit members, members pledge, leads sign partner agreements with other leads, and conversion plus onward-conversion rates get measured. Read from outside, that is **a franchise with a conversion funnel** — and intent does not travel; the cheaper reading wins. Two mitigations, both stateable publicly: the protocol must be **usable with zero affiliation** (no org membership required to run a session), and **R₀ is published honestly, including failures**. This is the **second independent instance** of a hazard already recorded once from the opposite direction (`content/articles/a58`, MLM-style recruitment architecture, found by self-audit rather than by audience simulation).

**Falsifier:** post the narrow claim and the response is substantive engagement with the *coordination-prerequisite* framing rather than the two narrower ones ⟹ the objection above is not how this audience reads it, and the framing constraint is wrong. See [decisions.md](decisions.md) 2026-08-12 [product]; narrative `content/articles/a68_is-it-research-or-positioning.md`. **Evidence grade: conversation-sourced, n=0 — no post has been made.**
...
**Meta-protocol scope (2026-03-27):** ClarityPledge is not a universal epistemology — it's a meta-protocol sitting underneath any epistemology that values comprehension. The only commitment required: "verify before you falsify." This scope means the protocol can bridge religious and ideological divides — not by producing agreement, but by increasing the resolution of disagreement. "Each accurately mapped disagreement is a research program" — once you know exactly where you diverge, you have a specific, attackable question. Disagreement trees don't always converge to agreement, but they always converge to more precise questions. More precise questions are closer to being answerable. The bridge is increasing resolution, not consensus.

**Meta-protocol non-neutrality caveat (2026-06-15):** The "verify before you falsify" commitment is not epistemology-neutral — paraphrase-verification presupposes a critical-rationalist stance (public corroboration over private certainty). CP therefore decontaminates disputes *within* an epistemology or *about which* to adopt, but cannot adjudicate *between* fundamentally incompatible epistemologies — it is a contestant there, not the referee (the problem of the criterion). It makes the meta-crux well-posed; it does not resolve it. Mirrors the lean-canvas §UVP caveat of the same date. Source: 2026-06-11 listening-calibration/trust conversation.
...
**Cognitive-domain scope (2026-05-19):** This construct names the *cognitive* recursion only. Emotional recursion ("I feel you feel what I feel") is a structurally similar but distinct problem with different verification mechanics (attunement, not paraphrase). When the cognitive-vs-emotional axis is load-bearing — typically when positioning against active-listening / NVC / emotional-attunement work — use the longer form *"illusion of recursive cognitive understanding."* The /live protocol verifies cognitive recursion; emotional attunement is a future or partner-channel extension, not an existing claim. Per the 2026-05-14 rename decision in [decisions.md](decisions.md), all three forms (recursive understanding / recursive belief / recursive cognitive understanding) are sanctioned — axis selects the form.

**Norm-theory extension (2026-05-19) — candidate defining contribution.** Classical norm theory (Bicchieri's experimental paradigms — trust, dictator, ultimatum games) is built on *visible compliance* and *defection* failures: every transfer is observable, and the failure mode is "I knew what was expected and chose not to," solved by incentives/monitoring/sanction. CP's leverage is the inverse quadrant — *invisible compliance* (understanding correctly leaves no external signature) and *misunderstanding* failures ("I intended to comply but my interpretation diverged"; no incentive system fixes this — motivation was never the problem). The intervention: a verification artifact (paraphrase, letter) that **converts the invisible/misunderstanding class into the visible/defection class** by making compliance observable. Mechanistically, verification converts *assumed* common knowledge (a phantom each party holds privately) into *actual* common evidence (a third object both can point at) — and evidence is what Bayesian updating requires and what confirmation bias resists. The shift is at the substrate level: not changing how individual minds process, but changing what objects are available to be processed. This is the formal version of "changing the error-correction layer all other norms run on top of" — every downstream norm whose enforcement depends on evidence-of-compliance becomes more enforceable when evidence is jointly held rather than privately interpreted. (Article home: a9.)
...
> **Epistemic placement (2026-08-07, P1026 D2): BELT — MRL 1-2, scale-gated.** The *aim* of a truth-measurement layer is hard-core **K7** ([research-programme.md](research-programme.md#k7--aim)); the point truth scores below that would realize it stay **in the protective belt, refutable**, alongside the Asymmetric Conversion Rate and asymmetry score in [philosophy.md](philosophy.md). Core content cannot earn corroborated novel predictions — immunizing these would forfeit the programme's best available source of progressivity.
...
| Both sides overestimate communication success | When both wrongly believe communication succeeded, neither seeks correction — self-concealing failure | Lau, Patel, Lickiss et al. 2022, "The extreme illusion of understanding" |
