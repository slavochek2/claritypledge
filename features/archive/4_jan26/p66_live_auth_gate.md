...
### Auth Gate
- [x] Update /live page: check auth on "Start New Meeting" click, redirect to `/signup` if not logged in

### Copy Updates
- [x] simple-navigation.tsx: "Try a Clarity Meeting" → "Start a Clarity Meeting" (2 places)
- [x] user-journey-section.tsx: "Try a Clarity Meeting" → "Start a Clarity Meeting"
- [x] dual-cta.tsx: "Try a Clarity Meeting" → "Start a Clarity Meeting" (2 places)
- [x] full-article-page.tsx: "Try a Clarity Meeting" → "Start a Clarity Meeting"
