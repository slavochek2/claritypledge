...
# P463: Clarity Partner Agreement
...
2. Run `/architect features/p463_clarity_partner_agreement.md` — data model (`clarity_agreements` table), visibility logic, invitation token system, email notifications, inline registration on acceptance
3. Run `/generate-tests features/p463_clarity_partner_agreement.md` — test coverage including compliance automation and visibility rules
4. Run `/dev features/p463_clarity_partner_agreement.md` — implement
