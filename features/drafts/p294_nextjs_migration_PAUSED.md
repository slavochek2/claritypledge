...
- `features/_drafts/p292_nextjs_migration_v2.md` - Fix-first attempt
- `features/_drafts/p291_incremental_nextjs_seo.md` - Incremental approach
...
*Previous specs: p24_front_to_next_js.md, p292_nextjs_migration_v2.md, p291_incremental_nextjs_seo.md, p25_nextjs_finalization.md*
