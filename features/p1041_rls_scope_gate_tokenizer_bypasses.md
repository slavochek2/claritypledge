...
- `E'...'` backslash-escape strings (found during code review, not the original adversarial review —
  `\'` inside an E-string doesn't terminate it, same desync-and-blank-the-rest-of-the-file failure mode
  as the other three).
