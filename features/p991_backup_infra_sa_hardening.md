...
- Full technical specifics (exact resource names, exact current permission grants, and one incidental related finding) are tracked privately, not in this public spec — see the private infra decisions log, entry dated 2026-07-15.
