...
- **What 14 co-founders taught me.** I lost the early ones to misunderstandings I didn't yet know how to catch: a co-founder who silently assumed we'd revisit the equity split (9 months lost), a technical co-founder who disagreed that 5 prospect rejections were enough to know the product was failing (7 months lost). I'll show how each gap hid as "conflict," and the question that would have surfaced it in week one.
- **One partnership I kept.** I worked with a co-founder for 3.5 years, and he disagreed with me constantly. He carried real risk with me — and it held because every time he pushed back, I made sure he felt heard, and when it mattered I made sure we actually understood each other before deciding. Only once we'd both verified would I ask him to back his case with evidence, and I'd accept that evidence. Disagreement stopped being friction the moment it was verified. I don't think we'd have lasted otherwise.
