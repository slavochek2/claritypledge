...
interface DualCTAProps {
  ...
  className?: string;
  /** Reverse the hierarchy: "Take the Pledge" becomes primary, "Try Meeting" becomes secondary */
  reversed?: boolean;
}

/**
 * Reusable dual CTA component used across landing pages.
 * Default: Primary = "Try a Clarity Meeting", Secondary = "Take the Pledge"
 * Reversed: Primary = "Take the Pledge", Secondary = "Try a Clarity Meeting"
 */
