...
interface DualCTAProps {
  ...
  className?: string;
  /** Reverse the hierarchy: "Take the Pledge" becomes primary, "Start a Clarity Meeting" becomes secondary */
  reversed?: boolean;
}

/**
 * Reusable dual CTA component used across landing pages.
 * Default: Primary = "Start a Clarity Meeting", Secondary = "Take the Pledge"
 * Reversed: Primary = "Take the Pledge", Secondary = "Start a Clarity Meeting"
 */
