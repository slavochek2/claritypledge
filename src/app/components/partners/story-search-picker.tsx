    ...
    <div ref={containerRef} className="w-full max-w-xs mx-auto">
      ...
      <div className="relative">
        ...
        <input
          ...
          className="w-full pl-9 pr-3 py-2.5 text-base md:text-sm border border-border rounded-xl bg-background text-foreground placeholder:text-muted-foreground focus-visible:outline-none focus:border-blue-300 focus-visible:ring-1 focus-visible:ring-blue-100 disabled:opacity-50"
        />
      </div>
