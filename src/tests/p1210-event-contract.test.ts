/**
 * P1210 DW-11 — rule presence at a named location.
 *
...
const SET = 'event-contract'

describe('P1210 DW-11 — ' + SET + ' rules present', () => {
  it('MUST-PASS: the real files RESOLVE every rule in the set', () => {
    ...
    console.log('[DW-11 must-pass]', r.detail)
  })
  ...
  it('MUST-FAIL: the fixture with one rule sentence deleted is REJECTED, naming it', () => {
    ...
    console.log('[DW-11 must-fail]', r.detail)
  })
