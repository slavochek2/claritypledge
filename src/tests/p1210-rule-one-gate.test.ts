/**
 * P1210 DW-6 — rule presence at a named location.
 *
...
describe('P1210 DW-6 — ' + SET + ' rules present', () => {
  it('MUST-PASS: the real files RESOLVE every rule in the set', () => {
    ...
    console.log('[DW-6 must-pass]', r.detail)
  })
  ...
  it('MUST-FAIL: the fixture with one rule sentence deleted is REJECTED, naming it', () => {
    ...
    console.log('[DW-6 must-fail]', r.detail)
  })
