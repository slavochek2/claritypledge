/**
 * P1210 DW-14 — rule presence at a named location.
 *
...
describe('P1210 DW-14 — ' + SET + ' rules present', () => {
  it('MUST-PASS: the real files RESOLVE every rule in the set', () => {
    ...
    console.log('[DW-14 must-pass]', r.detail)
  })
  ...
  it('MUST-FAIL: the fixture with one rule sentence deleted is REJECTED, naming it', () => {
    ...
    console.log('[DW-14 must-fail]', r.detail)
  })
