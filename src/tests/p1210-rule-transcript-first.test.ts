/**
 * P1210 DW-7 — rule presence at a named location.
 *
...
const SET = 'transcript-first'

describe('P1210 DW-7 — ' + SET + ' rules present', () => {
  it('MUST-PASS: the real files RESOLVE every rule in the set', () => {
    ...
    console.log('[DW-7 must-pass]', r.detail)
  })
  ...
  it('MUST-FAIL: the fixture with one rule sentence deleted is REJECTED, naming it', () => {
    ...
    console.log('[DW-7 must-fail]', r.detail)
  })
