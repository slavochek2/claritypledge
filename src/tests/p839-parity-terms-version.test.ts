...
const SERVER_ACCEPTED_request_letter_response_signin = ['v1.2'] as const;
const SERVER_ACCEPTED_create_and_open_letter = ['v1.2'] as const;
const SERVER_ACCEPTED_create_and_sign = ['v1.2'] as const;
