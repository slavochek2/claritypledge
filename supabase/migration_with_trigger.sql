-- IMPORTANT: Run this migration if you're experiencing "Profile not found" errors
-- This sets up the automatic profile creation trigger

-- First, ensure the profiles table has the correct structure
-- Drop and recreate if needed (WARNING: This will delete existing data)
-- If you have existing data, modify this to use ALTER TABLE instead

-- Drop existing tables if they exist (CAREFUL: removes all data)
...
-- Witnesses: Anyone can read witnesses
...
-- ============================================
-- CRITICAL: Trigger to auto-create profiles
-- ============================================
...
-- Confirm setup
select 'Migration completed successfully! The trigger is now active.' as status;
