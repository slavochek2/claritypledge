-- P721 defence-in-depth: cap steps_completed at total_steps in get_inbox_items().
--
-- Primary fix (IF FOUND guard) is in 20260416180000_p721_fix_stories_rated_guard.sql.
-- This cap ensures the inbox label never overflows even if dirty data reaches
-- the query — now or in future migrations that touch letter_deliveries.
--
