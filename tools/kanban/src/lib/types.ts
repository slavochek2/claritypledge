...
// Delivery stage (planning pipeline tracker — planning phase only, not implementation)
export type DeliveryStage =
  | '1-prd-review'    // PRD written by /create-prd, needs your read
  | '2-ux-review'     // UX designed by /ux, needs your read
  | '3-arch-review'   // Architecture written by /architect, needs your read
  | '4-tests-ready'   // Tests generated by /generate-tests, dev can start
